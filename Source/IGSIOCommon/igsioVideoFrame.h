...
functions to get/set its content from VTK images and byte arrays.
...
public:
  ...
  */
  ...
  /// TODO
  ///*! Get the VTK image, does not copy the pixel buffer */
  vtkUnsignedCharArray* GetCompressedFrameData() const;
  ...
  */
  ...
  void SetCompressedFrameData(vtkUnsignedCharArray* frameData);
  bool IsKeyFrame();
...
protected:
  ...
  bool UseCompression;
  int FrameType;
  vtkSmartPointer<vtkUnsignedCharArray> CompressedFrameData;
